...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.bidMaxPrice) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named bidMaxPrice');
    }
    ...
    this.circuits = {
      openAuction: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`openAuction: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('openAuction',
        ...
        const result_0 = this._openAuction_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      commitBid: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`commitBid: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._commitBid_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      closeAuction: (...args_1) => {
      ...
      settle: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const clearingPrice__0 = args_1[1];
        const totalAllocated__0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('settle',
                                     'argument 1 (as invoked from Typescript)',
                                     'auction.compact line 120 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(clearingPrice__0) === 'bigint' && clearingPrice__0 >= 0n && clearingPrice__0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('settle',
        ...
        if (!(typeof(totalAllocated__0) === 'bigint' && totalAllocated__0 >= 0n && totalAllocated__0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('settle',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(clearingPrice__0).concat(_descriptor_1.toValue(totalAllocated__0)),
      ...
      verifyCommitment: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`verifyCommitment: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyCommitment',
                                     'argument 1 (as invoked from Typescript)',
                                     'auction.compact line 130 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
    ...
    this.impureCircuits = {
      openAuction: this.circuits.openAuction,
  ...
  initialState(...args_0) {
    ...
    const tokenSymbol__0 = args_0[1];
    const allocation__0 = args_0[2];
    const settlementAssetCode__0 = args_0[3];
    const startTime__0 = args_0[4];
    const endTime__0 = args_0[5];
    const minimumBid__0 = args_0[6];
    const minimumBidSize__0 = args_0[7];
    const maxAllocationPerBidder__0 = args_0[8];
    ...
    if (!(tokenSymbol__0.buffer instanceof ArrayBuffer && tokenSymbol__0.BYTES_PER_ELEMENT === 1 && tokenSymbol__0.length === 32)) {
    ...
    if (!(typeof(allocation__0) === 'bigint' && allocation__0 >= 0n && allocation__0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 2 (argument 3 as invoked from Typescript)',
                                 'auction.compact line 68 char 1',
                                 'Uint<0..18446744073709551616>',
    ...
    if (!(settlementAssetCode__0.buffer instanceof ArrayBuffer && settlementAssetCode__0.BYTES_PER_ELEMENT === 1 && settlementAssetCode__0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 3 (argument 4 as invoked from Typescript)',
                                 'auction.compact line 68 char 1',
                                 'Bytes<32>',
                                 settlementAssetCode__0)
    }
    if (!(typeof(startTime__0) === 'bigint' && startTime__0 >= 0n && startTime__0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
    ...
    if (!(typeof(endTime__0) === 'bigint' && endTime__0 >= 0n && endTime__0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
    ...
    if (!(typeof(minimumBid__0) === 'bigint' && minimumBid__0 >= 0n && minimumBid__0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
    ...
    if (!(typeof(minimumBidSize__0) === 'bigint' && minimumBidSize__0 >= 0n && minimumBidSize__0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
    ...
    if (!(typeof(maxAllocationPerBidder__0) === 'bigint' && maxAllocationPerBidder__0 >= 0n && maxAllocationPerBidder__0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 8 (argument 9 as invoked from Typescript)',
                                 'auction.compact line 68 char 1',
                                 'Uint<0..18446744073709551616>',
                                 maxAllocationPerBidder__0)
    }
    ...
    state_0.setOperation('openAuction', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(1n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(tokenSymbol__0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(2n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(allocation__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(3n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(settlementAssetCode__0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(4n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(startTime__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(5n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(endTime__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(6n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(minimumBid__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(7n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(minimumBidSize__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(8n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(maxAllocationPerBidder__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 0n;
    __compactRuntime.queryLedgerState(context,
  ...
  _bidAmount_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('bidAmount',
                                 'return value',
                                 'auction.compact line 64 char 1',
                                 'Uint<0..18446744073709551616>',
                                 result_0)
    }
  ...
  _bidMaxPrice_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.bidMaxPrice(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('bidMaxPrice',
                                 'return value',
  ...
  _openAuction_0(context, partialProofData) {
  ...
  _commitBid_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    const price_0 = this._bidMaxPrice_0(context, partialProofData);
    ...
    __compactRuntime.assert(amount_0
                            ...
                            _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value),
                            'bid below minimum size');
    __compactRuntime.assert(price_0
                            >=
                            _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
    ...
    __compactRuntime.assert(amount_0
                            ...
                            _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value),
                            'bid exceeds max allocation per bidder');
    const commitment_0 = this._persistentCommit_0([amount_0, price_0], salt_0);
  ...
  _settle_0(context, partialProofData, clearingPrice__0, totalAllocated__0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                            ...
                            2,
                            'auction not closed');
    __compactRuntime.assert(totalAllocated__0
                            <=
                            _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(9n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(clearingPrice__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(10n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(totalAllocated__0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _verifyCommitment_0(context, partialProofData, commitment_0) {
