...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      registerAuction: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`registerAuction: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const contractAddress_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerAuction',
                                     'argument 1 (as invoked from Typescript)',
                                     'registry.compact line 21 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(contractAddress_0),
        ...
        const result_0 = this._registerAuction_0(context,
                                                 partialProofData,
                                                 contractAddress_0);
    ...
    this.impureCircuits = { registerAuction: this.circuits.registerAuction };
    this.provableCircuits = { registerAuction: this.circuits.registerAuction };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('registerAuction', new __compactRuntime.ContractOperation());
  ...
  _registerAuction_0(context, partialProofData, contractAddress_0) {
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(id_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(contractAddress_0),
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'registry.compact line 16 char 1',
